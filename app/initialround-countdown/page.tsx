...
export const END_TIME = new Date("2025-09-06T17:04:00"); // Final round end time
export const CRITICAL_HOURS = 2; // Critical period in hours (e.g., 3 hours before the end)
